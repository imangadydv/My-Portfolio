...
import { MdOutlineDesignServices } from "react-icons/md"; // Replace for Material-UI
...
const SkillsSection = () => {
  const skills = [
    ...
    { name: "Data Structures & Algorithms", icon: <FaJava /> }, // Placeholder icon
    { name: "SQL", icon: <FaDatabase /> },
    { name: "Redux", icon: <SiRedux /> },
    { name: "Express", icon: <SiExpress /> },
    { name: "MongoDB", icon: <SiMongodb /> },
    { name: "Material-UI", icon: <MdOutlineDesignServices /> }, // Replaced icon
    { name: "HTML", icon: <FaHtml5 /> },
    { name: "CSS", icon: <FaCss3Alt /> },
    { name: "C", icon: <FaJava /> }, // Placeholder icon
